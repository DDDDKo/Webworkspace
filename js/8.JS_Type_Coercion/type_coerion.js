...
/*
    숫자 타입으로 형변환
    - `+` 연산자를 제외한 나머지 산술 연산 혹은 대소 비교 연산에 대하여 좌, 우항 중 하나라도 숫자가 존재하면 숫자가 아닌 항을 숫자 타입으로 변경하여 연산함
*/
console.log('1' - 0);
...
/*
    불리언 타입으로 형변환
    - ''(빈 문자열), -0, 0, NaN, null, undefined는 false, 그이외의 데이터에 대해서는 true로 변경하여 연산을 진행
*/
