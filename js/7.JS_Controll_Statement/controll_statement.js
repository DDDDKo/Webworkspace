...
/*
    switch 문
    - 표현식을 비교하여 값이 표현식과 일치하면 해당하는 case문으로 실행 순서를 옮김 (ex. case3부터 실행시작으로 옮기면 case3부터 밑으로 쭉 실행)
    - 표현식과 일치하지 case가 존재하지 않으면 default 문으로 이동
...
/*
    break 문 
    - switch 문, 반복문에서 코드 블럭을 강제로 탈출할 때 사용
*/
let count = 0;
while(true){
    if( count === 5) break;
